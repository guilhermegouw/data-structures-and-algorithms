...
You also have a list of requirements: a list of building that are important to
you. For instance, you might value having a school and a gym near your
apartment. The list of blocks that you have contains information at every block
about all of the buildings that are present and absent at the block in
...
of the block that'thats most optimal for you.
...
Output:  // at index 3, the farthest you'd have to walk to reach a gym, a
         // school, or a store is 1 block; at any other index, you'd have to
         // walk farther.
3
"""
