"""
Challenge: Valid IP Addresses
Level: Medium

You're given a string of lenght 12 or smaller, containing only digits. Write a
...
0s. For example, "192.168.0.1" is a valid IP address, but "192.168.00.1" and
"192.168.0.01" aren't because they contain "00" and "01", respectively. Another
example of a valid IP address is "99.1.1.10"; conversely, "991.1.1.0" isn't
valid, because "991" is greater than 255.
...
Note: The IP addresses could be ordered differently.
"""
